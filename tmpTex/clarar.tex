...
\end{defi}
Hemos definido de este modo la \tbi{compactificación de Alexandroff} aunque no hemos probado aún que $X*$ sea un espacio compacto ni que su topología este bien definida siquiera, pasamos a hacerlo ahora. Para ello vamos a comprobarlo como una serie observaciones que probaremos inmediatamente.
