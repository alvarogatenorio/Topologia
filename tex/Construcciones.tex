...
\begin{exa}[Otros espacios cociente interesantes]\
	\begin{enumerate}
		...
		\begin{figure}[h!]
			\centering
			\subfigure[Banda de Möbius]{\includegraphics[scale = 0.09]{img/pol_fund_mobius}}
...
\end{prop}
	...
	\end{proof}
\begin{prop}
	Dado el espacio producto $(Y,\prod\T_i)$ y $a:=(a_1,\dots,a_r)\in Y$ tenemos que: \[\V=\{V_{a_1}\times\cdots\times V_{a_r}:W_i\in \V_{a_i} \text{ base de entornos de $a_i$ en } \T_i\} \] es base de entornos de $a$ en el producto.
\end{prop}
\begin{proof}
