...
\begin{figure}[h!]
	\centering
	\subfigure[El corro de la patata]{\includegraphics[scale = 0.4]{img/pivote_variante1}}
...
\begin{cor}[Cadenas]
	Sea una cadena finita $\{A_i\}_{i=1}^n$ de conexos que verifica que $A_i\cap A_{i+1}\not=\emptyset$. Entonces $\bigcup_{i=1}^n A_i$ es conexo.
\end{cor}
\begin{proof}
