...
\begin{prop}
	...
	\begin{enumerate}
		...
		\item $f(\adher{A})=\adher{f(A)}$ para cualquier subconjunto $A$ de $\X$.
	...
	\begin{proof}
		...
		\begin{enumerate}[align=left, leftmargin=*]
			...
			\item[\fbox{$(2)\Longleftrightarrow (3)$}] % TODO: completar
			...
			\item[\fbox{$(5)\implies (2)$}] Es análogo a $(4)\implies (1)$.
		\end{enumerate}
	\end{proof}
\end{prop}
