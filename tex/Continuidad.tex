...
\begin{exa}[Homeomorfismos] Comencemos volviendo al ejemplo recurrente de la aplicación identidad.
	\begin{enumerate}
		...
		Este ejemplo nos puede resultar ilustrativo de que nos basta con encontrar una $f$ homeomorfa entre nuestros espacios, pero no en todo el plano (lo cual es mucho más ambicioso).\qedhere
	\end{enumerate}
\end{exa}
