...
\begin{proof}
	...
	Se deja al lector la demostración de dados dos compactos $\W$ y $\F$, disjuntos, contenidos en espacio topológico $\X$ que es \hausdorff, tienen entornos disjuntos, en la que se utiliza también la proposición anterior.
\end{proof}
