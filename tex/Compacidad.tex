...
Vayamos estudiando qué subespacios de un espacio topológico $\X$ localmente compacto lo son también. Finalmente concluiremos que la compacidad local se hereda a los subespacios localmente cerrados (como ya adelantamos).
