...
\begin{proof}
	...
	\end{enumerate}
\end{proof}
Continuamos con una pequeña observación.
...
\end{obs}
\begin{theo}[Unicidad]
	La compactificación de Alexandroff es única.
\end{theo}
\begin{proof}
	$X^*$ es única, es decir, es homeomorfa a toda otra compactificación por un punto.
...
\end{proof}
A modo de resumen podemos decir que la compactificación de Alexandroff es realmente compactificación y además, el hecho de hacer a un espacio compacto añadiendo un único punto caracteriza a la compactificación de Alexandroff. Para terminar esta sección vamos a ver unos pocos ejemplos de compactificaciones.
\begin{exa}
