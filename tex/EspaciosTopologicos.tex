...
\begin{exa}[Topología de Sorgenfrey en $\R$]
	...
	$\B$ es base de una topología, a la que llamaremos \tbitop{de Sorgenfrey} o \tbitop{del límite inferior}. Para ver esto usaremos la proposición \ref{etop_base_top}.
	...
	\item Todo subconjunto de $\R$ no unipuntual admite una partición formada por dos clopens Sorgenfrey. Como veremos más adelante, esto significará que no hay conjuntos ``conexos'' salvo los puntos.
	\item La recta de Sorgenfrey es separable.
	\item La recta de Sorgenfrey es I axioma.
	
	tomamos $[a, a+\frac{1}{k})$
	\item La recta de Sorgenfrey no es II axioma.
	\end{enumerate}
	Con esto ya conocemos muchas propiedades de este espacio tan exótico.
\end{exa}
