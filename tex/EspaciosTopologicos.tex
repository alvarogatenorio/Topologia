...
\begin{exa}[Topologías]
	...
	\begin{enumerate}
		...
		\begin{figure}[h!]
			...
			\caption{Ejemplo de topología discreta para un conjunto finito formado por tres puntos}
		...
		\begin{figure}[h!]
			...
			\caption{Ejemplo de topología del punto (en este caso el punto a) para un conjunto finito formado por tres puntos}
			\label{cont_img_lemins}
		\end{figure}
